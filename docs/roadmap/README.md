...
| M5 | Scalability measurement and evidence-led streaming improvements | implemented: baseline, lazy materialization, shared bounded batches, and bounded authoring plans; production plugin reads remain buffered pending a reopenable two-pass source workflow |
